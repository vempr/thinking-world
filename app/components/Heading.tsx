    ...
    <nav className="bg-white dark:bg-neutral-900 block w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-neutral-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <Link
            to="/schedule/work"
            className="text-white bg-sky-600 hover:bg-sky-700 focus:ring-4 focus:outline-none focus:ring-sky-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:hover:bg-sky-600 dark:focus:ring-sky-700"
          >
            Your Schedule
          </Link>
          <button
